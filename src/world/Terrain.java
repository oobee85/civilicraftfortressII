...
public enum Terrain {
		GRASS (1, 1.5, 0, new String[] {"resources/Images/grass/grass16.png", "resources/Images/grass/grass128.png", "resources/Images/grass/grass512.png"}),
		DIRT  (0.5, 1.4, 0, new String[] {"resources/Images/dirt/dirt16.png", "resources/Images/dirt/dirt128.png", "resources/Images/dirt/dirt512.png"}),
		...
		VOLCANO (4, 8, 0.1, new String[] {"resources/Images/lava/volcano16.png", "resources/Images/lava/volcano128.png", "resources/Images/lava/magma512.png"}),
	...
	Terrain(double roadCost, double speed, double brightness, String[] s) {
		this.movePenalty = speed;
