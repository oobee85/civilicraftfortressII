...
public enum ResourceType {
	...
	CLAY (400, 100 , 10, 5, false, 0, 100, ItemType.CLAY, true, 10, "FARMING",
			new String[] {"Images/resources/clay_ore.png"}),
	
	//		    numVeins  isRare?   maxHeight
	//   effort     Veinsize   minHeight                      ticksHarvest
	COPPER (400, 100 , 12, 10, false, 0, 250, ItemType.COPPER_ORE, true, 5, "FARMING",
			new String[] {"Images/resources/copper/ore_copper128.png"}),
	SILVER (400, 100, 12, 5, false, 0, 250, ItemType.SILVER_ORE, true, 5, "FARMING",
			new String[] {"Images/resources/silver/ore_silver128.png"}),
	GOLD   (400, 100, 5, 8, false, 0, 350, ItemType.GOLD_ORE, true, 10, "FARMING",
	...
	IRON (400, 100, 5, 8, false, 0, 500, ItemType.IRON_ORE, true, 5, "BRONZE_WORKING",
			new String[] {"Images/resources/iron/ore_iron128.png"}),
	
	MITHRIL (400, 100, 4, 8, true, 350, 1000, ItemType.MITHRIL_ORE, true, 10, "IRON_WORKING",
			new String[] {"Images/resources/mithril/ore_mithril128.png"} ),
	
	ADAMANTITE (400, 100, 2, 5, true, 500, 800, ItemType.ADAMANTITE_ORE, true, 15, "ARMORING",
			new String[] {"Images/resources/adamantite/ore_adamant128.png"} ),
	
	RUNITE  (400, 100 , 1, 5, true, 500, 1000, ItemType.RUNITE_ORE, true, 15,"CIVILIZATION",
			new String[] {"Images/resources/runite/ore_rune128.png"}),
	TITANIUM (400, 100, 1, 3, true, 500, 1000, ItemType.TITANIUM_ORE, true, 15, "CIVILIZATION",
