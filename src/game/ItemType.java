...
public enum ItemType implements HasImage {
	...
	ADAMANTITE_BAR ( "resources/Images/itemicons/adamantite_bar.png", ResearchType.CHIVALRY, 	new HashMap<ItemType, Integer>() { {put(ItemType.ADAMANTITE_ORE,10);put(ItemType.COAL,16); }}, BuildingType.BLACKSMITH),
	RUNITE_BAR ( "resources/Images/itemicons/runite_bar.png", ResearchType.CHIVALRY, 			new HashMap<ItemType, Integer>() { {put(ItemType.RUNITE_ORE,10);  	put(ItemType.COAL,32);}}, BuildingType.BLACKSMITH),
	TITANIUM_BAR ( "resources/Images/itemicons/copper_bar.png", ResearchType.CHIVALRY, 			new HashMap<ItemType, Integer>() { {put(ItemType.TITANIUM_ORE,10); 	put(ItemType.COAL,64); }}, BuildingType.BLACKSMITH),
