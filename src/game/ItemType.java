...
public enum ItemType implements HasImage {
	...
	COPPER_BAR ( "resources/Images/itemicons/copper_bar.png", null, 							new HashMap<ItemType, Integer>() { {put(ItemType.COPPER_ORE,10);	put(ItemType.COAL,4); }}),
	IRON_BAR ( "resources/Images/itemicons/iron_bar.png", ResearchType.IRON_WORKING, 			new HashMap<ItemType, Integer>() { {put(ItemType.IRON_ORE,10); 		put(ItemType.COAL,8);  }}),
	BRONZE_BAR ( "resources/Images/itemicons/bronze_bar.png", ResearchType.BRONZE_WORKING, 		new HashMap<ItemType, Integer>() { {put(ItemType.COPPER_ORE,5); 	put(ItemType.SILVER_ORE, 5); put(ItemType.COAL,8); }}),
	SILVER_BAR ( "resources/Images/itemicons/silver_bar.png", null, 							new HashMap<ItemType, Integer>() { {put(ItemType.SILVER_ORE,10); 	put(ItemType.COAL,8);}}),
	MITHRIL_BAR ( "resources/Images/itemicons/mithril_bar.png", ResearchType.ARMORING, 			new HashMap<ItemType, Integer>() { {put(ItemType.MITHRIL_ORE,10); 	put(ItemType.COAL,12); }}),
	GOLD_BAR ( "resources/Images/itemicons/gold_bar.png", ResearchType.CURRENCY, 				new HashMap<ItemType, Integer>() { {put(ItemType.GOLD_ORE,10); 		put(ItemType.COAL,12); }}),
	
	ADAMANTITE_BAR ( "resources/Images/itemicons/adamantite_bar.png", ResearchType.CHIVALRY, 	new HashMap<ItemType, Integer>() { {put(ItemType.ADAMANTITE_ORE,10);put(ItemType.COAL,16); }}),
	RUNITE_BAR ( "resources/Images/itemicons/runite_bar.png", ResearchType.CHIVALRY, 			new HashMap<ItemType, Integer>() { {put(ItemType.RUNITE_ORE,10);  	put(ItemType.COAL,32);}}),
	TITANIUM_BAR ( "resources/Images/itemicons/copper_bar.png", ResearchType.CHIVALRY, 			new HashMap<ItemType, Integer>() { {put(ItemType.TITANIUM_ORE,10); 	put(ItemType.COAL,64); }}),
	...
	MITHRIL_SWORD ( "resources/Images/itemicons/mithril_sword.png", ResearchType.ARMORING, new HashMap<ItemType, Integer>() { {put(ItemType.MITHRIL_BAR,5); put(ItemType.WOOD, 10); }}),
	
	ADAMANT_SWORD ( "resources/Images/itemicons/adamant_sword.png", ResearchType.CHIVALRY, new HashMap<ItemType, Integer>() { {put(ItemType.ADAMANTITE_BAR,5); put(ItemType.WOOD, 10); }}),
