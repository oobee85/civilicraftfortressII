...
public enum ItemType implements HasImage {
	...
	MITHRIL_BAR ( "resources/Images/itemicons/mithril_bar.png", ResearchType.ARMORING, 			new HashMap<ItemType, Integer>() { {put(ItemType.MITHRIL_ORE,10); 	put(ItemType.COAL,15); }}),
	...
	ADAMANTITE_BAR ( "resources/Images/itemicons/adamantite_bar.png", ResearchType.CHIVALRY, 	new HashMap<ItemType, Integer>() { {put(ItemType.ADAMANTITE_ORE,10);put(ItemType.COAL,30); }}),
	...
	TITANIUM_BAR ( "resources/Images/itemicons/copper_bar.png", ResearchType.CHIVALRY, 			new HashMap<ItemType, Integer>() { {put(ItemType.TITANIUM_ORE,10); 	put(ItemType.COAL,80); }}),
