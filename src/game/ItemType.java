...
public enum ItemType {
	...
	SHIELDS   			("RESEARCH_LAB",  makeCosts(SHIELD,20),	"Images/interfaces/upgrades/shields.png", "Increases health of all units by : 100"),
	MEDICINE   			("RESEARCH_LAB",  makeCosts(BREAD,20),	"Images/interfaces/upgrades/medicine.png", "Decreases ticks to heal of all units by : 10"),
	BETTER_FORMATIONS   ("RESEARCH_LAB",  makeCosts(SHIELD,20),	"Images/interfaces/upgrades/better_formations.png", "Decreases ticks to move of all units by : 5"),
	FASTER_TRAINING   	("RESEARCH_LAB",  makeCosts(BREAD,20),	"Images/interfaces/upgrades/faster_training.png", "Decreases the ticks to produce units by : 50"),
	UNDYING_ARMY   		("RESEARCH_LAB",  makeCosts(BREAD,100),"Images/interfaces/upgrades/undying_army.png", "Gives all units lifesteal"),
	BROADHEADS   		("RESEARCH_LAB",  makeCosts(BOW, 20),	"Images/interfaces/upgrades/broadheads.png", "Increases damage of all projectiles by : 25"),
