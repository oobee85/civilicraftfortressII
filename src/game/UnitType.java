...
public enum UnitType implements HasImage {
	WORKER           ( "resources/Images/units/worker.png", 	new CombatStats(200,  0, 15, 1, 20, 10, 100), false, false, false, null, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50);  }}, null ),
 	...
 	LONGBOWMAN     ( "resources/Images/units/longbowman.png", 	new CombatStats(200, 30, 15, 5, 30, 10, 100), false, false, false, ResearchType.IRON_WORKING, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50); }}, null ),
 	CATAPULT     ( "resources/Images/units/catapult.png", 		new CombatStats(200, 100, 50, 10, 100, 10, 100), false, false, false, ResearchType.IRON_WORKING, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50); }}, null ),
 	...
 	KNIGHT           ( "resources/Images/units/knight.png", new CombatStats(600, 80, 10, 1, 20, 10, 100), false, false, false, ResearchType.CHIVALRY, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50); put(ItemType.MITHRIL_ORE,10); put(ItemType.HORSE,20);}}, null ),
