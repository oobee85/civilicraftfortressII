...
public enum UnitType implements HasImage {
	WORKER           ( "resources/Images/units/worker.png", 	new CombatStats(100,  0, 15, 1, 20, 30, 50), false, false, false, null, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50);  }}, null, null ),
 	...
 	ARCHER           ( "resources/Images/units/archer.png", 	new CombatStats(200, 10, 15, 3, 30, 100, 50), false, false, false, "WARRIOR_CODE", new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,100); put(ItemType.BRONZE_BAR,1); }}, null, ProjectileType.ARROW_ARCHER ),
 	...
 	LONGBOWMAN     ( "resources/Images/units/longbowman.png", 	new CombatStats(200, 30, 15, 6, 30, 300, 50), false, false, false, "ENGINEERING", new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,100); put(ItemType.MITHRIL_BAR, 5); }}, null, ProjectileType.ARROW ),
 	CATAPULT     ( "resources/Images/units/catapult.png", 		new CombatStats(100, 100, 50, 10, 100, 500, 100), false, false, false, "MATHEMATICS", new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.MITHRIL_BAR,5);}}, null, ProjectileType.ROCK_CATAPULT ),
 	TREBUCHET     ( "resources/Images/units/trebuchet.png", 	new CombatStats(100, 400, 50, 20, 100, 750, 100), false, false, false, "MONARCHY", new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.RUNITE_BAR,10);}}, null, ProjectileType.FIREBALL_TREBUCHET ),
 	...
 	HORSEARCHER ( "resources/Images/units/horsearcher.png", new CombatStats(200, 60, 5, 3, 20, 500, 50),  false, false, false, "CHIVALRY", new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,200); put(ItemType.HORSE,200); put(ItemType.RUNITE_BAR,5);}}, null, ProjectileType.RUNE_ARROW ),
