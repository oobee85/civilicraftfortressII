...
public enum UnitType implements HasImage {
	WORKER           ( "resources/Images/units/worker.png", new CombatStats(100,  1, 15, 1, 20), false, false, false, null, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50);  }}, null ),
 	...
 	KNIGHT           ( "resources/Images/units/knight.png", new CombatStats(500, 30, 10, 1, 40), false, false, false, ResearchType.CHIVALRY, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50); put(ItemType.MITHRIL_ORE,10); put(ItemType.HORSE,20);}}, null ),
 	...
 	HORSEARCHER ( "resources/Images/units/horsearcher.png", new CombatStats(100, 30, 5, 3, 30), false, false, false, ResearchType.HORSEBACK_RIDING, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50); put(ItemType.HORSE,10);}}, null ),
 	
	DEER		("resources/Images/units/deer.png", 	new CombatStats(200, 5, 5, 1, 20), 	false, false, false, null, null, ResourceType.DEAD_ANIMAL),
	HORSE		("resources/Images/units/horse.png",	new CombatStats(300, 5, 5, 1, 20), 	false, false, false, null, null, ResourceType.DEAD_ANIMAL),
	PIG			("resources/Images/units/pig.png",		new CombatStats(400, 20, 30, 1, 20), 	false, false, false, null, null, ResourceType.DEAD_ANIMAL),
	...
	COW			("resources/Images/units/cow.png",		new CombatStats(400, 10, 15, 1, 20), 	false, false, false, null, null, ResourceType.DEAD_ANIMAL),
	...
	WOLF		("resources/Images/units/wolf.png",		new CombatStats(200, 25, 10, 1, 20), 	false, false, true, null, null, ResourceType.DEAD_ANIMAL),
