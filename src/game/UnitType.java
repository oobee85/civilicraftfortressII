...
public enum UnitType implements HasImage {
	WORKER           ( "resources/Images/units/worker.png", 	new CombatStats(100,  0, 15, 1, 20, 30, 50), false, false, false, null, new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,50);  }}, null, null ),
 	...
 	LONGBOWMAN     ( "resources/Images/units/longbowman.png", 	new CombatStats(200, 0, 15, 6, 30, 300, 50), false, false, false, "ENGINEERING", new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,100); put(ItemType.MITHRIL_BAR, 5); }}, null, ProjectileType.ARROW_LONGBOWMAN ),
 	...
 	CHARIOT         ( "resources/Images/units/chariot.png", new CombatStats(300, 30, 10, 5, 30, 300, 50), false, false, false, "HORSEBACK_RIDING", new HashMap<ItemType, Integer>() { {put(ItemType.FOOD,200); put(ItemType.WOOD,200); put(ItemType.HORSE,100); put(ItemType.IRON_BAR,10);}}, null, ProjectileType.ARROW_LONGBOWMAN ),
