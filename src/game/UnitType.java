...
public enum UnitType implements HasImage {
	WORKER         ( "resources/Images/units/worker.png", new CombatStats(100, 0, 10, 1), false, false, false, null, new HashMap<ItemType, Integer>() { {put(ItemType.WHEAT,50);  }} ),
 	...
 	SPEARMAN    ( "resources/Images/units/spearman.png", new CombatStats(200, 10, 10, 1), false, false, false, ResearchType.BRONZE_WORKING, new HashMap<ItemType, Integer>() { {put(ItemType.WHEAT,50); put(ItemType.COPPER_ORE,20);}} ),
 	ARCHER         ( "resources/Images/units/archer.png", new CombatStats(50, 20, 10, 2), false, false, false, ResearchType.WARRIOR_CODE, new HashMap<ItemType, Integer>() { {put(ItemType.WHEAT,50); }}),
 	SWORDSMAN  ( "resources/Images/units/swordsman.png", new CombatStats(200, 20, 10, 1), false, false, false, ResearchType.IRON_WORKING, new HashMap<ItemType, Integer>() { {put(ItemType.WHEAT,50); put(ItemType.IRON_ORE,20);}}),
 	HORSEMAN    ( "resources/Images/units/horseman.png", new CombatStats(100, 10, 20, 2), false, false, false, ResearchType.HORSEBACK_RIDING, new HashMap<ItemType, Integer>() { {put(ItemType.WHEAT,50); put(ItemType.COPPER_ORE,10); put(ItemType.HORSE,10);}}),
