...
public enum BuildingType implements HasImage {
	 	...
	 	WINDMILL (1000, "resources/Images/buildings/ancientwindmill.png", 0.1, true, ResearchType.CONSTRUCTION),
		SAWMILL (1000, "resources/Images/buildings/sawmill.png", 0.1, true, null),
	 	BRIDGE (500, "resources/Images/buildings/bridge.png", 0, true, null),
	 	FARM (500, "resources/Images/buildings/farm.png", 0.1, true, ResearchType.FARMING),
	 	GRANARY (500, "resources/Images/buildings/granary.png", 0.1, true, null),
	 	CASTLE (5000, "resources/Images/buildings/castle256.png", 2.5, true, null),
		BARRACKS (1000, "resources/Images/buildings/barracks256.png", 0.5, true, ResearchType.WARRIOR_CODE)
	 	;
