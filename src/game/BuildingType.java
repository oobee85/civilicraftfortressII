...
public enum BuildingType implements HasImage {
	 	...
	 	WALL_STONE (1000, 200, "resources/Images/buildings/wall_stone.png", 0, false, 1,
	 			ResearchType.ENGINEERING,  new HashMap<ItemType, Integer>() { {put(ItemType.STONE,200);	put(ItemType.WOOD,200);  }}),
	 	...
	 	GATE_STONE (1000, 400, "resources/Images/buildings/gate_stone.png", 0, false, 1,
	 			ResearchType.ENGINEERING,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,400); put(ItemType.STONE,400); put(ItemType.MITHRIL_BAR,10); }}),
	 	GATE_BRICK (5000, 1000, "resources/Images/buildings/gate_brick.png", 0, false, 1,
	 			ResearchType.MONARCHY,  new HashMap<ItemType, Integer>() { {put(ItemType.STONE,600); put(ItemType.WOOD,600); put(ItemType.ADAMANTITE_BAR,10); }}),
	 	...
	 	WATCHTOWER (500, 250, "resources/Images/buildings/watchtower.png", 0, true, 10,
				ResearchType.MYSTICISM,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.MITHRIL_BAR,5); }}),
		...
		WORKSHOP (1000, 250, "resources/Images/buildings/workshop.png", 0.25, true, 1,
				ResearchType.MATHEMATICS,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,200); put(ItemType.STONE,200); put(ItemType.IRON_BAR,10); }}),
