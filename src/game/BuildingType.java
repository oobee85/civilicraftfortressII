...
public enum BuildingType implements HasImage {
	 	...
	 	WINDMILL (1000, 500, "resources/Images/buildings/ancientwindmill.png", 0.25, true, 
	 			ResearchType.CONSTRUCTION,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,100);  }}),
		SAWMILL (1000, 250, "resources/Images/buildings/sawmill.png", 0.25, true, 
				null,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,100);  }}),
	 	FARM (500, 250, "resources/Images/buildings/farm.png", 0.25, true, 
	 			ResearchType.FARMING,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,100);  }}),
	 	GRANARY (500, 500, "resources/Images/buildings/granary.png", 0.25, true, 
	 			null,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,100);  }}),
	 	CASTLE (4000, 1000, "resources/Images/buildings/castle256.png", 1, true, 
	 			null,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,1000); put(ItemType.STONE,1000);  }}),
		BARRACKS (1000, 250, "resources/Images/buildings/barracks256.png", 0.25, true, 
				ResearchType.WARRIOR_CODE,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.STONE,100);  }}),
		WORKSHOP (1000, 250, "resources/Images/buildings/workshop.png", 0.25, true, 
				ResearchType.WARRIOR_CODE,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.STONE,500);  }}),
		BLACKSMITH (1000, 250, "resources/Images/buildings/blacksmith.png", 0.25, true, 
				ResearchType.WARRIOR_CODE,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.STONE,500);  }}),
		RESEARCHLAB (1000, 250, "resources/Images/buildings/research.png", 0.25, true, 
				ResearchType.WARRIOR_CODE,  new HashMap<ItemType, Integer>() { {put(ItemType.WOOD,500); put(ItemType.STONE,500);  }}),
